...
public final class ElevatorConstants {
    ...
    public static final CANcoderConfiguration kEncoderAConfig = new CANcoderConfiguration()
            .withMagnetSensor(
                    new MagnetSensorConfigs()
                            .withAbsoluteSensorDiscontinuityPoint(Rotations.of(1))
                            .withMagnetOffset(Rotations.of(0))
                            .withSensorDirection(SensorDirectionValue.Clockwise_Positive));
    public static final CANcoderConfiguration kEncoderBConfig = new CANcoderConfiguration()
            .withMagnetSensor(
                    new MagnetSensorConfigs()
                            .withAbsoluteSensorDiscontinuityPoint(Rotations.of(1))
                            .withMagnetOffset(Rotations.of(0))
    ...
    public static final Angle[] kReefPositionsPracticeField = {
            Rotations.of(0.0), Rotations.of(1.39), Rotations.of(2.69), Rotations.of(4.875)
    };
    ...
    public static final Angle sourcePosition = Rotations.of(.169);
