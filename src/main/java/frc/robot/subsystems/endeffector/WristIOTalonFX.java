...
public class WristIOTalonFX implements WristIO {
  ...
  public WristIOTalonFX() {
    motor = new TalonFX(EndeffectorConstants.kWristMotorID);
    ...
    PhoenixUtil.applyMotorConfigs(
        motor, EndeffectorConstants.kWristMotorConfig, EndeffectorConstants.kFlashConfigRetries);
  ...
  public void setPosition(double position) {
    if (EndeffectorConstants.kUseMotionMagic) {
