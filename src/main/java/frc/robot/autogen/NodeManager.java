    ...
    for (Node node : nodes) {
      ...
      switch (node.nodeType()) {
        case PRELOAD -> {
          ...
          preloadTraj
              .atTimeBeforeEnd(.5)
              .toggleOnTrue(elevator.toReefLevel(3).alongWith(arm.toReefLevel(2)));
          Command scoreCmd =
        ...
        case SCORE_AND_INTAKE -> {
          ...
          switch (node.scoringType()) {
            case L1 -> {
              scoringTraj
                  .atTimeBeforeEnd(.5)
                  .toggleOnTrue(arm.toReefLevel(0).alongWith(elevator.toReefLevel(0)));
              scoreCmd =
                  endEffector
                      .setL1Velocity()
            ...
            case L2 -> {
              scoringTraj
                  .atTimeBeforeEnd(.5)
                  .toggleOnTrue(arm.toReefLevel(1).alongWith(elevator.toReefLevel(1)));
              scoreCmd =
                  endEffector
                      .setL2L3Velocity()
                      .until(endEffector.coralBeamBreak)
            ...
            case L3 -> {
              scoringTraj
                  .atTimeBeforeEnd(.5)
                  .toggleOnTrue(arm.toReefLevel(1).alongWith(elevator.toReefLevel(2)));
              scoreCmd =
                  endEffector
                      .setL2L3Velocity()
                      .until(endEffector.coralBeamBreak)
            ...
            case L4 -> {
              scoringTraj
                  .atTimeBeforeEnd(.5)
                  .toggleOnTrue(arm.toReefLevel(2).alongWith(elevator.toReefLevel(3)));
              scoreCmd =
                  endEffector
                      .setL4Voltage()
                      .until(endEffector.coralBeamBreak)
